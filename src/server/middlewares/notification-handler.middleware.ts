...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'restaurant.create': { roles: ['owner'], key: 'restaurant-profile-created', tenantPath: [], userPath: [] },
  'table.create': { roles: ['owner'], key: 'table-added', tenantPath: ['restaurant', 'table'], userPath: [] },
  'user.create': { roles: ['owner'], key: 'chef-invited', tenantPath: ['restaurant', 'user'], userPath: [] },
  'menu.create': { roles: ['chef'], key: 'menu-item-added', tenantPath: ['restaurant', 'menu'], userPath: [] },
  'reservation.create': {
    roles: ['guest'],
    key: 'table-reservation-made',
